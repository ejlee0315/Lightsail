"""Stage 1 BO — Disordered lattice (2x2 supercell + jitter), thin, 1550-1850.

8 optimization parameters: 7 base + jitter_amplitude.
Hole positions perturbed by controllable jitter → broadband scattering.

Usage:
    python3 scripts/run_stage1_disordered_thin.py [--seed 42]
"""
...
def main() -> None:
    ...
    overrides["name"] = f"stage1_disordered_thin_s{args.seed}"
    print("=" * 72)
    print(f"Stage 1 DISORDERED — 1550-1850, t=5-300, 2x2 jitter supercell, seed={args.seed}")
    print(f"  params: 8 (7 base + jitter_amplitude)")
